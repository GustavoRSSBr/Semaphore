 ...
 *      e fazer transações com bancos de dados. 
 *      
 * 		Por ter uma quantidade grande de núcleos de processamentos  e  threads,  
 * 		além  de  um  bom  algoritmo  de  escalonamento  de  threads,  
 * 		
 * 		Enquanto as  threads  fazem  cálculos,  estes  podem  ocorrer  simultaneamente,  
 * 
 * 		Mas  quando se faz a transação no banco de dados, esta deve ser apenas uma thread por vez.  
 * 
 * 
 * 		- Considere  um  conjunto  de  threads  com  IDs  definidas  na  própria  aplicação 
		com  números iniciando em 1 e incrementando de um em um.
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		for (int id = 1; id <= 21; id++) {
			ThreadTransacoes tt = new ThreadTransacoes(id, semaforo);
			tt.start();
		}
